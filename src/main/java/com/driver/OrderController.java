...
OrderService orderService;
    ...
    public ResponseEntity<String> addPartner(@PathVariable String partnerId){
            orderService.AddDelivery(partnerId);
        return new ResponseEntity<>("New delivery partner added successfully", HttpStatus.CREATED);
    }

    @PutMapping("/add-order-partner-pair")
    public ResponseEntity<String> addOrderPartnerPair(@RequestParam String orderId, @RequestParam String partnerId){
            orderService.AddBoth(orderId,partnerId);
    ...
    public ResponseEntity<DeliveryPartner> getPartnerById(@PathVariable String partnerId){
        ...
        DeliveryPartner deliveryPartner = orderService.getByPartnerId(partnerId);
    ...
    public ResponseEntity<Integer> getOrderCountByPartnerId(@PathVariable String partnerId){
        ...
        Integer orderCount = orderService.countOrderByPartner(partnerId);
    ...
    public ResponseEntity<List<String>> getOrdersByPartnerId(@PathVariable String partnerId){
        List<String> orders = orderService.getOrderListBypartnerId(partnerId);
